...
class Comentarios(models.Model):
    ...
    aparcamiento_comentado = models.ForeignKey('Aparcamientos', default="")
    autor = models.ForeignKey(User)
    def __unicode__(self):
        return unicode(self.autor)

class Seleccionados(models.Model):
    aparcamiento_seleccionado = models.ForeignKey('Aparcamientos')
    usuario = models.ForeignKey(User)
    fecha = models.DateField(auto_now_add=True)
    def __unicode__ (self):
        return unicode(self.aparcamiento_seleccionado)
